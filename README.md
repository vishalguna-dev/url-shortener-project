...
🚦 How to Run Locally
Database Setup: Create a schema named url_shortener in your MySQL instance.

Configuration: Update src/main/resources/application.properties with your credentials:
